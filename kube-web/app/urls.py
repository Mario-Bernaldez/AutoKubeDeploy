...
urlpatterns = [
    ...
    path("configure/deployment/", views.deployment_config_view, name="configure_deployment"),
    path("configure/service/", views.service_config_view, name="configure_service"),
    path("configure/namespace/", views.namespace_config_view, name="configure_namespace"),
